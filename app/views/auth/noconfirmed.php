...
<head>
  ...
  <title>OpenDoorsClass — Confirmez votre compte</title>
</head>
...
<body>
  ...
  <div class="confirmation-container">
    ...
    <h1>Votre compte n'est pas encore confirmé</h1>

    <p class="description">
      Un code de confirmation a été envoyé à
      <strong class="recipient-email"><?= htmlspecialchars($email) ?></strong>.
      Saisissez le code à 6 chiffres ci-dessous pour activer votre compte et accéder à votre formation.
    </p>
    ...
    <div class="resend-wrapper">
      ...
      <!-- <span id="resend-message" style="font-size:0.85rem;color:#00c48c;text-align:center;display:none;margin-top:8px;">
    ...
    <div style="margin-top:20px;text-align:center;">
      <a href="./logout" style="font-size:0.8rem;color:#aaa;text-decoration:none;transition:color 0.2s;">
        <i class="fas fa-right-from-bracket" style="margin-right:4px;"></i>
        Se déconnecter
      </a>
    </div>
  ...
  <script src="js/auth/noconfirmed.min.js" defer></script>
